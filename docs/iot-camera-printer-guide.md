...
![ATOM Lite本体の仕様図](images/device-atom-lite.png){width=6.2in}
...
![感熱プリンターユニットの仕様図](images/device-printer.png){width=6.2in}
...
![M5StickV本体の仕様図](images/device-stickv.png){width=6.2in}
...
![M5PaperColor本体の仕様図](images/device-papercolor.png){width=6.2in}
