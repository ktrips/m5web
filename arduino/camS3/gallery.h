...
// CamS3 camera captures), saved to Storage::fs() (flash or SD, see storage.h) as packed 1bpp bitmaps —
// same format the printer itself consumes, width always
// Printer::kPrintWidthDots. Independent of any in-RAM live-preview state
// "last frame" concept — this is a longer, on-disk history the web UI can browse,
...
// phone uploads never set a label.
...
// full or a filesystem error). feedSave() appends a chunk, returning false on
